// Initial data extracted from the first PDF report: Daily SAP Prospect Intelligence Report-Mexico-120326

export const initialProspects = [
  {
    id: "continental-automotive-120326",
    ...
    needs: [
      "Preparación del landscape SAP Basis",
      "Infraestructura para migración a S/4HANA",
      "Soporte de rendimiento e integración"
    ],
  ...
  },
  {
    ...
    needs: [
      "Soporte SAP Basis para despliegue",
      "Optimización de BD HANA",
      "Gobernanza de entornos SAP"
    ],
  ...
  },
  {
    ...
    needs: [
      "Consolidación de landscape",
      "Migración a la nube",
      "Soporte operativo Basis"
    ],
  ...
  },
  {
    ...
    needs: [
      "Escalamiento de entornos SAP",
      "Transición a la nube",
      "Gestión de rendimiento Basis"
    ],
  ...
  },
  {
    ...
    needs: [
      "Especialistas SAP Basis subcontratados",
      "Soporte para migración",
      "Infraestructura para grandes proyectos"
    ],
...
export const initialReportHistory = [
  {
    id: "report-120326",
